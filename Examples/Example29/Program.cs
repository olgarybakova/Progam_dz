...
//найдёт сумму натуральных элементов в промежутке от M до N._
...
//2. Метод рекурсии сумму натуральных элементов
// 
...
int RekurSum(int n,int m)  //Метод рекурсии сумму натуральных элементов
{
    if (n > m)
    {
