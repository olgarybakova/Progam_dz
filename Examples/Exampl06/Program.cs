...
//32679 -> 6
// Исходя из примеров выше вывода третьей цифры, делаю вывод, что выводить третью
//цифру считая слева.
//1.метод определения количества цифр в числе
//2.метод создания массива из заданного числа
//3. Делаем проверку на количество цифр в числе. Выводим результат
